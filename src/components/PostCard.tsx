...
const PostCard = ({post}: {post: Post}) => (
  <div className="bg-white shadow-lg rounded-lg p-0 pb-12 mb-8">
    <div className="relative shadow-md inline-block w-full h-60 mb-4">
      <Image
        unoptimized
        alt={post.title}
        className="shadow-lg rounded-t-lg lg:rounded-lg object-cover"
        fill={true}
    ...
    <div className="block lg:flex text-center items-center justify-center mt-8 w-full">
