            ...
            {connected ?
                <div className="container mx-auto px-16 lg:px-52">
                    <div className="container mx-auto px-10 grid grid-cols-1 md:grid-cols-2 bg-white rounded-lg shadow-md mb-4">
                        ...
                        <div className="py-5 md:py-10 px-10 mb-5 flex justify-center items-center">
                            {isEditing ?
                                <form onSubmit={handleSubmit} className="space-y-2">
                                    ...
                                    <div className="mb-2">
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="border-gray-400 border-2 rounded-md px-3 py-2 w-full h-18"
                                        />
                                    </div>
                    ...
                    <div className="w-full h-56 bg-white rounded-lg shadow-md">
                        <div className="py-10 px-10">
                            <p className="inline align-middle text-black ml-2 text-5xl">Dashboard</p>
                        </div>
                    </div>
                </div>
            :
